...
\foreach \X in {1,2,...,1024} {
  ...
  % adding an intrinsic colour to the star. The code below produces equal ammout of red and blue stars (this is not a realistic value, again just what looked nice), the intensity of the colour is random
