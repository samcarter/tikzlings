...
%
% Eyes %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fill[white!90!gray] 						(-0.28, 1.6) circle (0.22);
\owl@part@draw{brown!30!black} 	(-0.28, 1.6) circle (0.15);
\fill[white!90!gray] 						(0.28, 1.6) circle (0.22);
\owl@part@draw{brown!30!black} 	(0.28, 1.6) circle (0.15);
...
%
% Bill %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\owl@part@draw{orange} (0, 1.4) -- (-0.1, 1.3) -- (0, 1.15) -- (0.1, 1.3) -- cycle;
%
% Feet %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\owl@part@draw{orange} (0.175,0.2) ellipse (0.03 and 0.1);
\owl@part@draw{orange,rotate around={20:(0.225,0.21)}} (0.225,0.21) ellipse (0.03 and 0.1);
\owl@part@draw{orange,rotate around={40:(0.275,0.23)}} (0.275,0.23) ellipse (0.03 and 0.1);
\owl@part@draw{orange} (-0.175,0.2) ellipse (0.03 and 0.1);
\owl@part@draw{orange,rotate around={-20:(-0.225,0.21)}} (-0.225,0.21) ellipse (0.03 and 0.1);
\owl@part@draw{orange,rotate around={-40:(-0.275,0.23)}} (-0.275,0.23) ellipse (0.03 and 0.1);
}
