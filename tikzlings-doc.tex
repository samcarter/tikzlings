...
\AddToHook{tikzlings/coati/background}{\path (-1.63,0.1) rectangle (1.63,2.26);}
...
\newcommand{\tocentrysam}[3]{%
  ...
  % 2: Title
  % 3: tikz code
  \RemoveFromHook{tikzlings/coati/background}%
  \RemoveFromHook{tikzlings/mouse/background}%
  \RemoveFromHook{tikzlings/cat/background}%
  \RemoveFromHook{tikzlings/dog/background}%
  \hyperref[#1]{%
