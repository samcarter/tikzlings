...
\lstdefinestyle{duckstyle}{%
  ...
  moretexcs={
    ...
    % tikzlings names
    marmot, coati, bear, koala, owl, penguin, thing, tikzling, snowman, mouse, moles, sloth, pig, cat, hippo, rhino, panda, bee, anteater, squirrel, bearwear, sheep, chicken, elephant, bug, bat, wolf, ape,
    % other
