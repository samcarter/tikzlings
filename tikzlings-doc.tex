...
The basic usage is the same for all animals (and beings). Inside a \saminline|tikzpicture|, the \tikzlings can be added via {\bfseries\color{listingcolor}\saminline|\<name_of_the_tikzling>|}. For example
