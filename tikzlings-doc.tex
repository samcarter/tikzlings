...
\begin{tikzpicture}
    ...
    \begin{scope}[canvas is zy plane at x=\thelayer*1.8]
      \planes
      \fill[gray]  (-0.1772, 2.0686) .. controls (-0.2057, 2.1602) and (-0.3552, 2.2076) .. (-0.3552, 2.1922) .. controls (-0.3552, 2.1922) and (-0.3694, 1.9615) .. (-0.2855, 1.9615) .. controls (-0.2264, 1.9462) and (-0.1772, 1.9462) .. (-0.1772, 2.0686) -- cycle;
      \fill[gray]  (0.1772, 2.0686) .. controls (0.2057, 2.1602) and (0.3552, 2.2076) .. (0.3552, 2.1922) .. controls (0.3552, 2.1922) and (0.3694, 1.9615) .. (0.2855, 1.9615) .. controls (0.2264, 1.9462) and (0.1772, 1.9462) .. (0.1772, 2.0686) -- cycle;
      \fill[gray!55!white] ( 0.55,  0.8 ) .. controls ( 0.55 , 0.4) and ( 0.35, 0.19) .. ( 0.0,  0.19) .. controls (-0.35, 0.19) and (-0.55 , 0.4) .. (-0.55,  0.8 ) .. controls (-0.55 , 1.3) and (-0.35, 1.65) .. ( 0.0,  1.65) .. controls ( 0.35, 1.65) and ( 0.55 , 1.3) .. ( 0.55,  0.75) -- cycle;
    \end{scope}
    \addtocounter{layer}{1}
    \begin{scope}[canvas is zy plane at x=\thelayer*1.8]
      \hooks
    ...
    \begin{scope}[canvas is zy plane at x=\thelayer*1.8]
      \planes
      \fill[gray,rotate around={90:(0.3,1.0)}] (0.3,1.0) ellipse[x radius=0.24, y radius=0.13];
      \fill[gray,rotate around={-90:(-0.3,1.0)}] (-0.3,1.0) ellipse[x radius=0.24, y radius=0.13];
      \fill[gray!55!white] (0, 1.76) circle[radius=0.36];
      \fill[white] (-0.11, 1.83) ellipse[x radius=0.08, y radius=0.12];
      \fill[white] (0.11, 1.83) ellipse[x radius=0.08, y radius=0.12];
      \fill[black] (-0.105, 1.78) ellipse[x radius=0.04, y radius=0.07];
      \fill[black] (0.105, 1.78) ellipse[x radius=0.04, y radius=0.07];
      \fill[gray!80!white] (0, 1.55) ellipse[x radius=0.36, y radius=0.2];
      \fill[white!95!yellow] (0, 1.7911) .. controls (-0.0231, 1.7372) and (-0.0463, 1.6832) .. (-0.0642, 1.6274) .. controls (-0.0687, 1.6132) and (-0.0724, 1.5981) .. (-0.0678, 1.5834) .. controls (-0.0603, 1.552) and (-0.0287, 1.5287) .. (0, 1.531) .. controls (0.0287, 1.5287) and (0.0603, 1.552) .. (0.0678, 1.5834) .. controls (0.0724, 1.5981) and (0.0687, 1.6132) .. (0.0642, 1.6274) .. controls (0.0463, 1.6832) and (0.0231, 1.7372) .. (0, 1.7911) -- cycle;
      \fill[gray!70!black,line width=0.4pt] (0.125, 1.5) arc [start angle=-50, end angle=-130, radius=0.2] ;
      \begin{scope}
        \clip (-0.5,0.4) rectangle (0.5,0.13);
        \fill[gray] (-0.25,0.15) ellipse[x radius=0.16, y radius=0.17];
        \fill[gray] (0.25,0.15) ellipse[x radius=0.16, y radius=0.17];
        \fill[gray] (0.25,0.13) ellipse[x radius=0.05, y radius=0.1];
        \fill[gray] (0.13,0.11) ellipse[x radius=0.05, y radius=0.1];
        \fill[gray] (0.37,0.11) ellipse[x radius=0.05, y radius=0.1];
        \fill[gray] (-0.25,0.13) ellipse[x radius=0.05, y radius=0.1];
        \fill[gray] (-0.13,0.11) ellipse[x radius=0.05, y radius=0.1];
        \fill[gray] (-0.37,0.11) ellipse[x radius=0.05, y radius=0.1];  
      \end{scope}
