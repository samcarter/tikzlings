...
\emph{If you look very closely at the group picture in \href{https://www.tug.org/TUGboat/tb39-2/tb122wright-tug18.pdf}{TUG goes to Rio} you can spot the real B\"ar}
...
\emph{The koala was generously contributed by the TeX.Stackexchange user \@marmot and is named for a \LaTeX developer from Down Under}
...
\emph{The idea for the mouse came from an Italian TeX.Stackexchange user and Tokz is a combination of the Italian word for mouse and \TikZ}
...
\emph{The owl Jake was inspired by the avatar of one of the top TeX.Stackexchange users}
