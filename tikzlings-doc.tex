...
Given that the \tikzlings package uses everyday animal names for its macros, it sometimes conflicts with other packages which use the same macro names. The following example shows how such conflicts can be worked around:
\begin{tcblisting}{listing only,lower separated=false}
