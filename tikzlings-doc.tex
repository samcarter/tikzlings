...
\tocentrysam{sec:tikzlings}{Ti\emph{k}Zling}{\node[gray,font=\itshape] at (-0.3,1) {\scalebox{5}{?}};\node[gray,font=\itshape] at (0.3,1.3) {\scalebox{5}{?}};}%
\tocentrysam{sec:things}{Accessories}{\thing[signpost={\TeX},scale=0.8]\thing[sombrero,present]}%
\par
\endgroup
\makeatother
